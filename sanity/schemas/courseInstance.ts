...
export const courseInstance = defineType({
  ...
  fields: [
    ...
    defineField({
      name: "venueName",
      title: "Natančna lokacija",
      type: "string",
      description: "Primer: Fakulteta za šport",
    }),
    defineField({
      name: "startTime",
      title: "Začetek",
      type: "string",
      description: "Primer: 17:00",
    ...
    defineField({
      ...
      title: "Konec",
      type: "string",
      description: "Primer: 22:00",
      validation: (Rule) => Rule.regex(/^([01]\d|2[0-3]):[0-5]\d$/),
    }),
    defineField({
      name: "maxSpots",
      title: "Interna omejitev prijav",
      type: "number",
      description: "Operativna omejitev; številka se obiskovalcem ne prikazuje.",
      initialValue: 24,
