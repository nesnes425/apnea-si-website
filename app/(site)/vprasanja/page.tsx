...
const sections = [
  {
    ...
    faqs: [
      { q: "Kako poteka prijava na tečaj prostega potapljanja?", a: "Na tečaj se prijavite preko obrazca na strani Prijava. Ob tem izberete nivo, termin teoretičnega dela in termin praktičnega dela tečaja. Na vašo prijavo bomo odgovorili v najkrajšem možnem času." },
      ...
      { q: "Imam darilni bon, kako poteka prijava v tem primeru?", a: "Ob prejemu bona je najbolje, da se kar se da kmalu javite na email info@apnea.si ter sporočite, kateri termin tečaja vam najbolj odgovarja. Zaradi hitrega polnjenja mest je pametno, da si prosto mesto rezervirate čim prej. S tem je vaša prijava potrjena." },
      { q: "Kdaj prejmem učno gradivo?", a: "Učno gradivo prejmete, ko je vaša prijava na tečaj potrjena. Zanj se je potrebno prijaviti na povezavi mySSI." },
      { q: "Kako najlažje prebiram učno gradivo?", a: "Interaktivno učno gradivo boste najlažje prebirali s pomočjo aplikacije mySSI za Android in iOS pametne telefone ter tablice. Vanjo se vpišete z istimi podatki, kot ste jih uporabili pri registraciji v sistem SSI." },
      ...
      { q: "Ali si lahko opremo izposodim?", a: "Na voljo vam je izposoja vrhunske opreme za prosto potapljanje znamke Mares. Izposoja poteka v sodelovanju s trgovino Aquamania. V kolikor kupite kak kos opreme, na primer masko ali dihalko, je izposoja brezplačna, v nasprotnem primeru pa je izposoja celotne opreme za čas tečaja, bazen in globina, 40 €." },
      ...
      { q: "Ali imamo tečajniki kakšne ugodnosti pri nakupu opreme?", a: "Tečajniki imate posebne ugodnosti pri nakupu opreme v trgovini Aquamanija, Extremo, Aquas, Norik Sub in Scubatom. Več o ugodnostih in izdelkih v akciji boste izvedeli na tečaju." },
  ...
  },
  {
    ...
    faqs: [
      { q: "Kako poteka prijava na treninge?", a: "Na treninge se prijavite preko prijavnega obrazca na strani Treningi, kjer izberete lokacijo, termin in nivo. Mesto v izbrani skupini rezervirate s spletnim plačilom letne članarine." },
      ...
      { q: "Koliko znaša vadnina za udeležbo na treningih?", a: "Znesek letne vadnine je odvisen od lokacije in števila izbranih treningov na teden. Podrobnosti najdete na strani Treningi." },
      ...
      { q: "Kje treningi potekajo?", a: "Treningi potekajo v Ljubljani, Kranju, Radovljici, Novi Gorici, Novem mestu in Kopru. Več o lokacijah in bazenih najdete na strani Treningi." },
  ...
  },
  {
    ...
    faqs: [
      { q: "Kako lahko naročim darilni bon?", a: "Darilni bon lahko naročite na strani Darilni bon." },
